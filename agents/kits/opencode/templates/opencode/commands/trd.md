...
Read all relevant code for the feature:
- HTTP handlers (e.g. `internal/adapter/http/handler/`)
- Services (e.g. `internal/core/service/`)
- Domain structs (e.g. `internal/core/domain/`)
- Port interfaces (e.g. `internal/core/port/`)
- Repository models (e.g. `internal/adapter/repository/model/`)
- Migrations (e.g. `migrations/`)
